        ...
        <div className="flex flex-wrap items-center gap-2 self-start sm:self-auto">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <button
              ...
              className="p-2 sm:p-2.5 bg-white border border-slate-200 hover:bg-slate-50 text-slate-600 rounded-xl transition-colors shadow-xs"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-2 bg-emerald-50 border border-emerald-200 hover:bg-emerald-100 text-emerald-700 rounded-xl transition-colors shadow-xs text-xs font-bold disabled:opacity-50"
            >
              <Activity className={`w-3.5 h-3.5 ${testing ? 'animate-spin text-emerald-600' : ''}`} />
              <span className="hidden sm:inline">Canlı Test Et</span>
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-2 bg-white border border-red-200 hover:bg-red-50 text-red-600 rounded-xl transition-colors shadow-xs text-xs font-bold disabled:opacity-50"
            >
              <Trash2 className="w-3.5 h-3.5" />
              <span>{resetting ? '...' : 'Sıfırla'}</span>
            </button>
          </div>
        </div>
      </div>
      ...
      {loading || !data ? (
        ...
        <>
          ...
          <div className="bg-white p-6 sm:p-7 rounded-2xl border border-slate-200 shadow-xs space-y-6">
            ...
            {/* Bar Grafik Alanı - Mobilde yatay kaydırma */}
            <div className="overflow-x-auto pb-2">
              <div className="h-64 flex items-end gap-2 sm:gap-4 pt-6 border-b border-slate-100 px-2 min-w-[480px] sm:min-w-0">
